...
//            stopFromPlayGroup.ASIDs[i] = new AudioSourceID(asID.EntityID, -1, asID.Priority, PlaybackStateType.Stop);
...
//            AudioInfoGUISystem.ASIDPlayStatus[entity.Index] = PlaybackStateType.Stop;
//        }

//        for (int i = 0; i < stopGroup.Length; i++)
//        {
//            AudioSourceID asID = stopGroup.ASIDs[i];
//            if(asID.PlayStatus != PlaybackStateType.Stop)
//            {
...
//                }
//                stopGroup.ASIDs[i] = new AudioSourceID(asID.EntityID, -1, asID.Priority, PlaybackStateType.Stop);
...
//                poolGroup.Pool[0].ReturnIDBack(asID.ASID);
//            }
//            muteGroup.ASIDs[i] = new AudioSourceID(asID.EntityID, -1, asID.Priority, PlaybackStateType.Mute);
...
//            if (asID.PlayStatus == PlaybackStateType.NeedSource && lastTimeStarted == -1)
//            {
//                if (newClipID != -1)
...
//            if (asID.PlayStatus == PlaybackStateType.ReadyToPlay)
//            {
//                AudioSource audioSource = poolGroup.Pool[0].GetAudioSource(asID.ASID).GetComponent<AudioSource>();
...
//                audioSource.Play();
//                playGroup.ASIDs[i] = new AudioSourceID(asID.EntityID, asID.ASID, asID.Priority, PlaybackStateType.Play);
